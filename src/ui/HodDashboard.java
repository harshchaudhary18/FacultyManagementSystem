...
public class HodDashboard extends JFrame {
    ...
    public HodDashboard() {
        ...
        setTitle(
                "Faculty Duty & Workload Management System - HOD"
        );
        ...
        hodCircle.setForeground(
                Color.WHITE
        );

        hodCircle.setBackground(
                ACCENT_COLOR
        );

        hodCircle.setOpaque(true);

        hodCircle.setPreferredSize(
                new Dimension(
                        42,
                        42
                )
        ...
        JLabel welcomeSubtitle =
                new JLabel(
                        "Monitor your department's faculty, workload and duties."
                );
        ...
        JLabel quickSubtitle =
                new JLabel(
                        "Frequently used HOD management modules"
                );
        ...
        quickAutoDistribute.addActionListener(
                e -> autoDistributeWorkload()
        );
    ...
    private void autoDistributeWorkload() {

        int choice =
                JOptionPane.showConfirmDialog(
                        this,
                        "Are you sure you want to automatically distribute\n"
                                + "all workload equally among faculty?\n\n"
                                + "Existing faculty assignments will be rearranged.",
        ...
        boolean success =
                workloadDAO.autoDistributeWorkload();

        if (success) {

            JOptionPane.showMessageDialog(
                    this,
                    "Workload has been distributed successfully among faculty.",
                    "Auto Distribution Successful",
            ...
            JOptionPane.showMessageDialog(
                    this,
                    "Unable to distribute workload.\n"
                            + "Please make sure faculty and workload records exist.",
